...
def process_partition(eps=1e-6):
    ...
    for (patient_index, patient) in enumerate(patients):
        ...
        patient_ts_files = list(
            filter(lambda x: x.find("timeseries_readmission.csv") != -1, os.listdir(patient_folder)))
...
print(number_of_patients, number_of_stay, number_of_mortality, number_of_transfer_back, number_of_die_in_ward,
      number_of_readmit_within_30days, number_of_die_within_30days, number_of_readmission, number_of_not_readmission)
